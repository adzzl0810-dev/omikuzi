        ...
        <div className="min-h-screen relative overflow-hidden font-serif text-white pt-24 pb-20 px-4 md:px-8">
            ...
            <div className="relative z-10 max-w-xl mx-auto">
                ...
                >
                    ...
                    <p className="text-sm tracking-[0.3em] uppercase text-neon-cyan font-bold">
                        Lucky Item Oracle
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="bg-black/60 backdrop-blur-md p-8 rounded-xl border border-neon-cyan/30 shadow-[0_0_30px_rgba(0,255,255,0.1)] mb-8"
                >
                    <form onSubmit={handleCalculate} className="space-y-6">
                        ...
                        <button
                            ...
                            className={`w-full py-4 font-bold tracking-[0.2em] transition-all duration-300 border
                                ${loading
                                    ? "bg-gray-800 border-gray-700 text-gray-500 cursor-not-allowed"
                                    : "bg-neon-cyan/20 border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-black hover:shadow-[0_0_20px_#0ff]"
                                }`}
                        >
                ...
                {result && !loading && (
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="bg-gradient-to-br from-jap-indigo/80 to-black p-8 rounded-xl border border-jap-gold-300 text-center relative overflow-hidden group"
                    >
